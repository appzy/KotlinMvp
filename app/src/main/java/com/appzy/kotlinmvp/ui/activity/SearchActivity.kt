...
import com.appzy.kotlinmvp.mvp.contract.SearchContract
import com.appzy.kotlinmvp.mvp.model.bean.HomeBean
import com.appzy.kotlinmvp.mvp.presenter.SearchPresenter
...
import com.appzy.kotlinmvp.ui.adapter.HotKeywordsAdapter
import com.appzy.kotlinmvp.utils.CleanLeakUtils
import com.appzy.kotlinmvp.utils.StatusBarUtil
import com.appzy.kotlinmvp.view.ViewAnimUtils
import com.tencent.bugly.crashreport.CrashReport
import kotlinx.android.synthetic.main.activity_search.*

/**
 * Created by appzy on 2017/12/1.
 * desc:搜索功能
 */
...
class SearchActivity : BaseActivity(), SearchContract.View {
    ...
    override fun initView() {
        ...
        tv_cancel.setOnClickListener {
            CrashReport.testJavaCrash()//异常上报
            onBackPressed() }
        //键盘的搜索按钮
